...
#include "../../../src/NuageDeMotsGUI/processthread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProcessThread_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProcessThread_t qt_meta_stringdata_ProcessThread = {
    {
QT_MOC_LITERAL(0, 0, 13), // "ProcessThread"
QT_MOC_LITERAL(1, 14, 10), // "processEnd"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9) // "stringVec"

    },
    "ProcessThread\0processEnd\0\0stringVec"
};
...
void ProcessThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->processEnd((*reinterpret_cast< stringVec(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ProcessThread::*_t)(stringVec );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProcessThread::processEnd)) {
                *result = 0;
            }
        }
    }
...
void *ProcessThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProcessThread.stringdata))
...
// SIGNAL 0
void ProcessThread::processEnd(stringVec _t1)
{
